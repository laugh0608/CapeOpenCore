...
namespace CapeOpenCore.Class
{
    ...
    class UnitConverter : System.ComponentModel.StringConverter
    {
        ...
        {
            RealParameter unit = (RealParameter)context.Instance;
            string[] retVal = CDimensions.UnitsMatchingCategory(CDimensions.UnitCategory(unit.Unit));
    ...
    class RealParameterTypeConverter : ParameterTypeConverter
    {
        ...
        {
            if (typeof(RealParameter).IsAssignableFrom(destinationType))
                return true;
            return base.CanConvertTo(context, destinationType);
        }
        public override Object ConvertTo(System.ComponentModel.ITypeDescriptorContext context, System.Globalization.CultureInfo culture, Object value, System.Type destinationType)
        {
            if ((typeof(System.String).IsAssignableFrom(destinationType)) && typeof(RealParameter).IsAssignableFrom(value.GetType()))
            {
                RealParameter param = (RealParameter)value;
