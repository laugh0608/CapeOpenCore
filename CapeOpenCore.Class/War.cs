...
namespace CapeOpenCore.Class
{
    ...
    [CapeVersion("1.0")]
    [CapeVendorURL("http://www.epa.gov/nrmrl/std/sab/war/sim_war.htm")]
    ...
    public class WARAddIn : CapeObjectBase
    {
        ...
        public WARAddIn()
        {
            ...
            //}
            this.AddData(CapeOpen.Properties.Resources.WARdata);
        }
        ...
        public override System.Windows.Forms.DialogResult Edit()
        {
            try
            {
                WARalgorithm war = new WARalgorithm(this.warDataTable, this.FlowsheetMonitoring);
            ...
            {
                this.throwException(new CapeUnknownException(p_Ex.Message, p_Ex));
