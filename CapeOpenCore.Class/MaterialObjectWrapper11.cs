...
{    
    ...
    class MaterialObjectWrapper11 : CapeObjectBase,
        ICapeThermoMaterial,
    ...
    {        
        ...
        override public String ComponentName
        {
            get
            {
                return ((ICapeIdentification)p_IMatObj).ComponentName;
            }

            set
            {
                ((ICapeIdentification)p_IMatObj).ComponentName = value;
            }
        }
        ...
        override public String ComponentDescription
        {
            get
            {
                return ((ICapeIdentification)p_IMatObj).ComponentDescription;
            }
            set
            {
                ((ICapeIdentification)p_IMatObj).ComponentDescription = value;
            }
        }
        ...
        /// </summary>
        /// <remarks>
        /// The <see cref = "MaterialObjectWrapper11"/> class checks to determine whether the wrapped material object
