...
namespace CapeOpenCore.Class.CapeOpenUI
{
    ...
    public partial class WARalgorithm : Form
    {
        ...
        private ICapeFlowsheetMonitoring p_Monitoring;
        private System.Collections.Generic.List<ICapeUnitCOM> p_Units;
        private System.Collections.Generic.List<ICapeIdentification> p_Streams;
        private System.Collections.Generic.List<ICapeIdentification> p_InletStreams;
        private System.Collections.Generic.List<ICapeIdentification> p_OutletStreams;
        ...
        void ResetStreams()
        {
            ...
            ICapeCollection p_UnitColl = (ICapeCollection)p_Monitoring.GetUnitOperationCollection();
            ICapeCollection p_StreamColl = (ICapeCollection)p_Monitoring.GetStreamCollection();
            //
                ...
                if (p_UnitPortColl.Count() > 1)
                {
                    ...
                    for (int j = 0; j < p_UnitPortColl.Count(); j++)
                    {
                        ...
                        if (p_Port.connectedObject != null)
                        {
                            ...
                            if (p_Port.direction == CapePortDirection.CAPE_INLET)
                            {
                            ...
                            if (p_Port.direction == CapePortDirection.CAPE_OUTLET)
                            {
                                int objectToRemove = 0;
                        ...
                        {
                            if (p_Port.portType == CapePortType.CAPE_ENERGY)
            ...
            foreach (ICapeIdentification p_Id1 in p_OutletStreams)
            {
