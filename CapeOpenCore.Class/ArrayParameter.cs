...
namespace CapeOpenCore.Class
{
        ...
        ICapeArrayParameterSpec
    {
        ...
        public override bool Validate(ref String message)
        {
            ...
            args = new ParameterValidatedEventArgs(ComponentName, message, ValStatus, m_parameter.ValStatus);
        ...
        object[] ICapeArrayParameterSpec.ItemsSpecifications
        {
            get
            {
                return ((ICapeArrayParameterSpec)m_parameter.Specification).ItemsSpecifications;
            }
        }
        ...
        int[] ICapeArrayParameterSpec.Size
        {
            get
            {
                return ((ICapeArrayParameterSpec)m_parameter.Specification).Size;
            }
        }
