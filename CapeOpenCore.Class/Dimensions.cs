...
namespace CapeOpenCore.Class
{
    ...
    static class CDimensions
    {
        ...
        static CDimensions()
        {
            ...
            reader.LoadXml(CapeOpen.Properties.Resources.units);
            ...
            //}
            reader.LoadXml(CapeOpen.Properties.Resources.unitCategories);
        ...
        public static String AspenUnit(String unit)
        {
            ...
            for (int i = 0; i < unitCategories.Count; i++)
            {
                unitCategory current = (unitCategory)unitCategories[i];
        ...
        {
            string category = CDimensions.UnitCategory(unit);
